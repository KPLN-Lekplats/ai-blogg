...
topics = [
    ...
    },
    {
        ...
        "link_url": "https://www.kpln.se/category/parkmiljoter"  # Justera vid behov
    },
    {
        "topic": "skateparks",
...
# Skapa en prompt med instruktioner att skriva ett SEO-optimerat blogginlägg
...
if response.status_code == 200:
    ...
    # Skapa ett filnamn baserat på datum och valt ämne
    today = datetime.today().strftime('%Y-%m-%d')
    slug = chosen['topic'].replace(" ", "-")
    filename = f"blog/{today}-{slug}.md"

    # Skapa YAML-frontmatter
    front_matter = f"""---
layout: post
title: "{chosen['title']}"
date: {today}
...
"""
    ...
    # Skriv frontmatter och innehåll till filen
